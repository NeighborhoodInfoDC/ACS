/***PT***DM "clear log";***/
/*Libname stubs location of SequenceNumberTableNumberLookup dataset geographic*/
/***PT***LIBNAME stubs '/pc_common/dataproducts/2011/';***/
/***PT***LIBNAME sas   '/pc_common/dataproducts/KC/';***/
...
data work.&geography;
  ...
  /***PT***INFILE "/tab4/sumfile/prod/2007thru2011/geo/&geography..txt" MISSOVER TRUNCOVER LRECL=1500;***/
  /***PT>>>*/ INFILE "&_acs_sf_raw_path\&geography..txt" MISSOVER TRUNCOVER LRECL=1500;
...
/***PT***%let rootdir=/pc_common/dataproducts/2011/code/;***/
...
data _null_;
  ...
  /*Save code to FILE statement below*/
	...
	if _n_ =1 then 		 do;
   		/***PT***put "TITLE ""&type.20115&geo.&seq.000"";";***/		
   		/***PT>>>*/ put "TITLE2 ""&type.20115&geo.&seq.000"";";
		...
		put "		   LOGRECNO $7;";
		put " ";
		/***PT***put "INFILE '/tab4/sumfile/prod/2007thru2011/data/&type.20115&geo.&seq.000.txt' DSD TRUNCOVER DELIMITER =',' LRECL=3000;";***/
		/***PT>>>*/ put "INFILE ""&_acs_sf_raw_path\&type.20115&geo.&seq.000.txt"" DSD TRUNCOVER DELIMITER =',' LRECL=3000;";
		put " ";
...
/***PT***%include "&rootdir&type&geo._&seq..sas";***/
%mend;
...
/***PT***
     data sas.SF&seq&geo;
   	  merge  g20115&geo(IN=g) SFe&seq&geo(IN=x) SFm&seq&geo(IN=y);
    		by logrecno;
  	run;
***/
%end;
...
/***PT***%do i=1 %to 1;***/
/***PT>>>*/ %do i=&_state_fips %to &_state_fips;
	data _null_;
