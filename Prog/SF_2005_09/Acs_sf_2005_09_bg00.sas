/**************************************************************************
 Program:  Acs_sf_2005_09_bg00.sas
 Library:  ACS
...
%macro Read_seq( seqno );
  ...
  %let table_file_m_list = &table_file_m_list SFm&seqno.dc;
...
** Drop unneeded table 'E' cells **;

data Acs.Acs_sf_2005_09_&geo_suffix;
...
%let table_m_list = %ListChangeDelim( &table_list, new_delim=%str(e: ), quiet=y );
%let table_m_list = %unquote(&table_m_list.e:);
%put table_m_list=&table_m_list;

options msglevel=i;

data Acs_me_2005_09_&geo_suffix;
...
data Acs.Acs_me_2005_09_&geo_suffix;

  set Acs_me_2005_09_&geo_suffix;

  drop &drop_list ;
    
run;

%File_info( data=Acs.Acs_me_2005_09_&geo_suffix, printobs=0, freqvars=sumlevel )
