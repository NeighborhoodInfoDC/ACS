/**************************************************************************
 ...
 Description:  Create summary file from ACS 5-year data for 2012 Voting Precincts.
 
 Modifications:
  12/21/10 SXZ This program created to only summarize 2012 Voting Precincts
**************************************************************************/
