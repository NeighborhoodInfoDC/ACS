/**************************************************************************
 Program:  Acs_sf_2005_09_tr00.sas
 Library:  ACS
...
%let table_list = B00001 B00002 B01001 B01003 B03002 B05002 B17001 B23001 B15002 B11001
                  B11003 B11004 B25043 B25044 B19127 B19131 B25003 B25004;
...
data Acs.Acs_sf_2005_09_&geo_suffix;
  ...
  GeoBg2000 = substr( geoid, 8, 12 );
  
  label GeoBg2000 = 'Census block group (2000)';
  **/
  
  keep logrecno sumlevel state county tract blkgrp Geo2000 
       &table_e_list;

run;

%File_info( data=Acs.Acs_sf_2005_09_&geo_suffix, freqvars=sumlevel )
