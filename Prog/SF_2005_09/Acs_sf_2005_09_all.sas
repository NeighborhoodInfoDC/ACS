/**************************************************************************
 ...
 Modifications:
  06/02/11 PAT Read and output margin of error files.
**************************************************************************/
...
%macro Compile_ACS_2005_09( geo );
  ...
  %let drop_list = B01001Ee: B11001Ee: B25003Ee: B01001Em: B11001Em: B25003Em: ;
  
  %let drop_bg_list = B05002e: B05002m: B11013e: B11013m: B17001e: B17001m: B19131e: B19131m: B23001e: B23001m: ;
  ...
  **** Combine data table & margin of error files ****;
  ...
  %let table_m_list = %ListChangeDelim( &table_list, new_delim=%str(m: ), quiet=y );
