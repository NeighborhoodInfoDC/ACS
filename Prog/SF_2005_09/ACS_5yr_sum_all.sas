/**************************************************************************
 ...
 Modifications:
  12/19/12 SXZ Added to create summaries by 2012 Voting Precincts

  12/21/10 PAT Added unweighted sample count vars., Pop16andOverEmployed,
               Pop16andOverYears, NumRenterHsgUnits.
  ...
  10/19/12 PAT Added missing MOE vars.
               Used macro IFs to suppress missing vars for BG data.
**************************************************************************/
...
%macro Summary_geo( geo, source_geo );
  ...
  %if %upcase( &source_geo ) = BG %then %do;
    ...
    %let moe_vars =
           mTotPop_2005_09 mNumHshlds_2005_09 mNumFamilies_2005_09
           mPopUnder5Years_2005_09 mPopUnder18Years_2005_09 mPop65andOverYears_2005_09
           mPopWithRace_2005_09 mPopBlackNonHispBridge_2005_09
           mPopWhiteNonHispBridge_2005_09
           mPopAsianPINonHispBridge_2005_09 mPopHisp_2005_09
           mPopNativeAmNonHispBr_2005_09
           mPopOtherNonHispBridge_2005_09
           mPopMultiracialNonHisp_2005_09
           mPopOtherRaceNonHispBr_2005_09
           mPop25andOverWoutHS_2005_09 mPop25andOverWCollege_2005_09
           mPop25andOverYears_2005_09 mPop25andOverWHS_2005_09
           mNumHshldPhone_2005_09
           mNumHshldCar_2005_09 mAggFamilyIncome_2005_09
           mNumOccupiedHsgUnits_2005_09
           mNumOwnerOccupiedHU_2005_09
           mNumRenterOccupiedHU_2005_09 mNumVacantHsgUnits_2005_09
           mNumVacantHUForRent_2005_09
           mNumVacantHUForSale_2005_09 mNumRenterHsgUnits_2005_09           
           ;
  ...
  %else %do;
    ...
    %let moe_vars =
           ...
           mPopOtherNonHispBridge_2005_09
           mPopMultiracialNonHisp_2005_09
           mPopOtherRaceNonHispBr_2005_09 mPopPoorPersons_2005_09
           mPersonsPovertyDefined_2005_09 mPopPoorChildren_2005_09
           mChildrenPovertyDefined_2005_09 mPopPoorElderly_2005_09
           mElderlyPovertyDefined_2005_09 mPopCivilianEmployed_2005_09
           mPopUnemployed_2005_09 mPopInCivLaborForce_2005_09
           mPop16andOverEmployed_2005_09 mPop16andOverYears_2005_09
           mPop25andOverWoutHS_2005_09 mPop25andOverWCollege_2005_09
           mPop25andOverYears_2005_09 mPop25andOverWHS_2005_09
           mNumFamiliesOwnChildren_2005_09
           mNumFamiliesOwnChildFH_2005_09 mNumHshldPhone_2005_09
           mNumHshldCar_2005_09 mAggFamilyIncome_2005_09
           mNumOccupiedHsgUnits_2005_09
           mNumOwnerOccupiedHU_2005_09
           mNumRenterOccupiedHU_2005_09 mNumVacantHsgUnits_2005_09
  ...
  %if &geo_name = GEO2000 and %upcase( &source_geo_var ) = GEO2000 %then %do;
    ...
    ** Census tracts from census tract source: just recopy selected vars **;
    ...
    data Acs.&source_ds_work&geo_suffix (label="ACS summary, 5-year, &source_geo_label source, DC, &geo_label");
  ...
  %else %do;
    ...
    ** Transform data from source geography (&source_geo_var) to target geography (&geo_var) **;
    ...
    %Transform_geo_data(
      ...
      out_ds_label=%str(ACS summary, 5-year, &source_geo_label source, DC, &geo_label),
      calc_vars=,
      calc_vars_labels=,
      keep_nonmatch=N,
      show_warnings=10,
...
%macro Summary_geo_source( source_geo );
  ...
  %local year year_lbl year_dollar;
  ...
  %if %upcase( &source_geo ) = BG %then %do;
     ...
     %let source_geo_wt_file_fmt = $geobwtf.;
     %let source_ds = Acs_sf_2005_09_bg00;
     %let source_geo_label = Block group;
  %end;
  %else %if %upcase( &source_geo ) = TR %then %do;
     %let source_geo_var = Geo2000;
     %let source_geo_suffix = _tr;
     %let source_geo_wt_file_fmt = $geotwtf.;
     %let source_ds = Acs_sf_2005_09_tr00;
  ...
  %let source_ds_work = ACS_5yr_sum&source_geo_suffix;
  ...
  ** Create new variables for summarizing **;
  ...
  data &source_ds_work;
    ...
    ** Demographics **;
    ...
    %if %upcase( &source_geo ) = TR %then %do;
  ...
  %Summary_geo( anc2002, &source_geo )
  %Summary_geo( anc2012, &source_geo )
  %Summary_geo( city, &source_geo )
  %Summary_geo( cluster_tr2000, &source_geo )
  %Summary_geo( eor, &source_geo )
  %Summary_geo( psa2004, &source_geo )
  %Summary_geo( psa2012, &source_geo )
  %Summary_geo( geo2000, &source_geo )
  %Summary_geo( geo2010, &source_geo )
  %Summary_geo( ward2002, &source_geo )
  %Summary_geo( ward2012, &source_geo )
  %Summary_geo( zip, &source_geo )
