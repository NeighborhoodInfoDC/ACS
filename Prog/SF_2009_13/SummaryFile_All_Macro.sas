/**************************************************************************
 Program:  SummaryFile_All_Macro.sas
 Library:  ACS
 ...
 Modifications:
  02/03/16 CGH  Updated for 2009-13 ACS data.
**************************************************************************/
...
data _null_;
  ...
  /*Save code to FILE statement below*/
	...
	if _n_ =1 then 		 do;
   		put "TITLE2 ""&type.&_last_year.5&geo.&seq.000"";";
		...
		put "		   LOGRECNO $7;";
		put " ";
		put "INFILE ""&_acs_sf_raw_path\&type.&_last_year.5&geo.&seq.000.txt"" DSD TRUNCOVER DELIMITER =',' LRECL=3000;";
		put " ";
