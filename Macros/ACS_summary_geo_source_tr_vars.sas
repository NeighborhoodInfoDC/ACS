...
/*gender*/
      ...
      PopWorkFTLT75KB_M_&_years. = 
        sum(B20005Be24, B20005Be25 );

      PopWorkFTLT75KB_F_&_years. = 
        sum(B20005Be71, B20005Be72 );

      PopWorkFTLT75KW_M_&_years. = 
        sum(B20005He24, B20005He25 );

	  PopWorkFTLT75KW_F_&_years. = 
        sum(B20005He71, B20005He72 );

      PopWorkFTLT75KH_M_&_years. = 
        sum(B20005Ie24, B20005Ie25 );

      PopWorkFTLT75KH_F_&_years. = 
        sum(B20005Ie71, B20005Ie72);

      PopWorkFTLT75KA_M_&_years. = 
        sum(B20005De24, B20005De25, B20005Ee24, B20005Ee25  );

      PopWorkFTLT75KA_F_&_years. = 
        sum(B20005De71, B20005De72, B20005Ee71, B20005Ee72 );

      PopWorkFTLT75KIOM_M_&_years. = 
        sum(B20005Ce24, B20005Ce25, B20005Fe24, B20005Fe25, B20005Ge24, B20005Ge25 );

      PopWorkFTLT75KIOM_F_&_years. = 
        sum(B20005Ce71, B20005Ce72, B20005Fe71, B20005Fe72, B20005Ge71, B20005Ge72 );

      PopWorkFTLT75KAIOM_M_&_years. = 
        sum(B20005De24, B20005De25, B20005Ee24, B20005Ee25, B20005Ce24, B20005Ce25, B20005Fe24, B20005Fe25, B20005Ge24, B20005Ge25);

      PopWorkFTLT75KAIOM_F_&_years. = 
        sum(B20005De71, B20005De72, B20005Ee71, B20005Ee72,B20005Ce71, B20005Ce72, B20005Fe71, B20005Fe72, B20005Ge71, B20005Ge72 );
    ...
    mPop16_64EmployedB_M_&_years. = %moe_sum( var=C23002Bm5,C23002Bm7 );
     ...
     mPopWorkEarnB_M_&_years. = %moe_sum( var=B20005Bm5, B20005Bm28 );
      ...
      mPopWorkFTLT75KB_M_&_years. = 
        %moe_sum( var=B20005Bm24, B20005Bm25 );

      mPopWorkFTLT75KB_F_&_years. = 
        %moe_sum( var=B20005Bm71, B20005Bm72 );

      mPopWorkFTLT75KW_M_&_years. = 
        %moe_sum( var=B20005Hm24, B20005Hm25 );

	  mPopWorkFTLT75KW_F_&_years. = 
        %moe_sum( var=B20005Hm71, B20005Hm72 );

      mPopWorkFTLT75KH_M_&_years. = 
        %moe_sum( var=B20005Im24, B20005Im25 );

      mPopWorkFTLT75KH_F_&_years. = 
        %moe_sum( var=B20005Im71, B20005Im72);

      mPopWorkFTLT75KA_M_&_years. = 
        %moe_sum( var=B20005Dm24, B20005Dm25, B20005Em24, B20005Em25  );

      mPopWorkFTLT75KA_F_&_years. = 
        %moe_sum( var=B20005Dm71, B20005Dm72, B20005Em71, B20005Em72 );

      mPopWorkFTLT75KIOM_M_&_years. = 
        %moe_sum( var=B20005Cm24, B20005Cm25, B20005Fm24, B20005Fm25, B20005Gm24, B20005Gm25 );

      mPopWorkFTLT75KIOM_F_&_years. = 
        %moe_sum( var=B20005Cm71, B20005Cm72, B20005Fm71, B20005Fm72, B20005Gm71, B20005Gm72 );

      mPopWorkFTLT75KAIOM_M_&_years. = 
        %moe_sum( var=B20005Dm24, B20005Dm25, B20005Em24, B20005Em25, B20005Cm24, B20005Cm25, B20005Fm24, B20005Fm25, B20005Gm24, B20005Gm25);

      mPopWorkFTLT75KAIOM_F_&_years. = 
        %moe_sum( var=B20005Dm71, B20005Dm72, B20005Em71, B20005Em72,B20005Cm71, B20005Cm72, B20005Fm71, B20005Fm72, B20005Gm71, B20005Gm72 );
