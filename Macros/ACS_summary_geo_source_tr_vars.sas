...
/*gender*/
	...
	/*gender*/
      ...
      PopWorkFTB_M_&_years. = B20005B_003;
      PopWorkFTB_F_&_years. = B20005B_050;

      PopWorkFTW_M_&_years. = B20005H_003;
      PopWorkFTW_F_&_years. = B20005H_050;

      PopWorkFTH_M_&_years. = B20005I_003;
      PopWorkFTH_F_&_years. = B20005I_050;

      PopWorkFTA_M_&_years. = sum(B20005D_003, B20005E_003 );
      PopWorkFTA_F_&_years. = sum(B20005D_050, B20005E_050 );

      PopWorkFTIOM_M_&_years. = sum(B20005C_003, B20005F_003, B20005G_003 );
      PopWorkFTIOM_F_&_years. = sum(B20005C_050, B20005F_050, B20005G_050 );

      PopWorkFTAIOM_M_&_years. = sum(B20005D_003, B20005E_003,
                     B20005C_003, B20005F_003, B20005G_003 );
      PopWorkFTAIOM_F_&_years. = sum(B20005D_050, B20005E_050,
                     B20005C_050, B20005F_050, B20005G_050 );
...
/*gender*/
	  PopWorkFTLT35KB_M_&_years. = 
        sum(B20005B_006, B20005B_007, B20005B_008, B20005B_009, B20005B_010, B20005B_011,
            B20005B_012, B20005B_013, B20005B_014, B20005B_015);

	  PopWorkFTLT35KB_F_&_years. = 
        sum(B20005B_053, B20005B_054, B20005B_055, B20005B_056, B20005B_057, B20005B_058,
            B20005B_059, B20005B_060, B20005B_061, B20005B_062 );

      PopWorkFTLT35KW_M_&_years. = 
        sum(B20005H_006, B20005H_007, B20005H_008, B20005H_009, B20005H_010, B20005H_011,
            B20005H_012, B20005H_013, B20005H_014, B20005H_015 );

      PopWorkFTLT35KW_F_&_years. = 
        sum(B20005H_053, B20005H_054, B20005H_055, B20005H_056, B20005H_057, B20005H_058,
            B20005H_059, B20005H_060, B20005H_061, B20005H_062 );

      PopWorkFTLT35KH_M_&_years. = 
        sum(B20005I_006, B20005I_007, B20005I_008, B20005I_009, B20005I_010, B20005I_011,
            B20005I_012, B20005I_013, B20005I_014, B20005I_015 );

      PopWorkFTLT35KH_F_&_years. = 
        sum(B20005I_053, B20005I_054, B20005I_055, B20005I_056, B20005I_057, B20005I_058,
            B20005I_059, B20005I_060, B20005I_061, B20005I_062 );

      PopWorkFTLT35KA_M_&_years. = 
        sum(B20005D_006, B20005D_007, B20005D_008, B20005D_009, B20005D_010, B20005D_011,
            B20005D_012, B20005D_013, B20005D_014, B20005D_015,
            B20005E_006, B20005E_007, B20005E_008, B20005E_009, B20005E_010, B20005E_011,
            B20005E_012, B20005E_013, B20005E_014, B20005E_015);

      PopWorkFTLT35KA_F_&_years. = 
        sum(B20005D_053, B20005D_054, B20005D_055, B20005D_056, B20005D_057, B20005D_058,
            B20005D_059, B20005D_060, B20005D_061, B20005D_062,
            B20005E_053, B20005E_054, B20005E_055, B20005E_056, B20005E_057, B20005E_058,
            B20005E_059, B20005E_060, B20005E_061, B20005E_062 );

      PopWorkFTLT35KIOM_M_&_years. = 
        sum(B20005C_053, B20005C_054, B20005C_055, B20005C_056, B20005C_057, B20005C_058,
            B20005C_059, B20005C_060, B20005C_061, B20005C_062,
          B20005F_053, B20005F_054, B20005F_055, B20005F_056, B20005F_057, B20005F_058,
            B20005F_059, B20005F_060, B20005F_061, B20005F_062,
          B20005G_053, B20005G_054, B20005G_055, B20005G_056, B20005G_057, B20005G_058,
            B20005G_059, B20005G_060, B20005G_061, B20005G_062 );

	      PopWorkFTLT35KIOM_F_&_years. = 
        sum(B20005C_053, B20005C_054, B20005C_055, B20005C_056, B20005C_057, B20005C_058,
            B20005C_059, B20005C_060, B20005C_061, B20005C_062,
          , B20005F_054, B20005F_055, B20005F_056, B20005F_057, B20005F_058,
            B20005F_059, B20005F_060, B20005F_061, B20005F_062,
          B20005G_053, B20005G_054, B20005G_055, B20005G_056, B20005G_057, B20005G_058,
            B20005G_059, B20005G_060, B20005G_061, B20005G_062 );
      ...
      PopWorkFTLT35KAIOM_M_&_years. = 
        sum(B20005D_006, B20005D_007, B20005D_008, B20005D_009, B20005D_010, B20005D_011,
            ...
            B20005E_006, B20005E_007, B20005E_008, B20005E_009, B20005E_010, B20005E_011,
            B20005E_012, B20005E_013, B20005E_014, B20005E_015,
          B20005C_053, B20005C_054, B20005C_055, B20005C_056, B20005C_057, B20005C_058,
            B20005C_059, B20005C_060, B20005C_061, B20005C_062,
          B20005F_053, B20005F_054, B20005F_055, B20005F_056, B20005F_057, B20005F_058,
            B20005F_059, B20005F_060, B20005F_061, B20005F_062,
          B20005G_053, B20005G_054, B20005G_055, B20005G_056, B20005G_057, B20005G_058,
